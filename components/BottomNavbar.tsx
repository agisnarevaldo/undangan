...
export default function BottomNavbar({ isVisible = true }: BottomNavbarProps) {
  ...
  return (
    <nav
      className="text-center fixed bottom-0 left-0 right-0 z-50 rounded-t-3xl border-t border-gray-300 dark:border-gray-700 bg-white/80 dark:bg-[#212529]/80 backdrop-blur-md shadow-lg transition-all duration-300"
      id="navbar-menu"
    >
      <div className="flex justify-around w-full items-center m-0 p-0 py-1">
        <Link
          className="nav-link flex flex-col items-center gap-1 py-2 px-1 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 transition-colors no-underline"
          href="#home"
        >
