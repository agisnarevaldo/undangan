        ...
        <div className="rounded-3xl shadow-xl p-6 bg-white/80 dark:bg-black/60 backdrop-blur-md border border-white/20 dark:border-gray-800">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex justify-between items-start mb-1">
                            ...
                            <button
                              ...
                              className={`flex items-center gap-1 text-xs transition-colors self-start ${comment.isLiked
          ...
          <form onSubmit={handleSubmit} className="mt-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mt-2 px-1 gap-1">
              ...
              <p
                className={`hidden md:block text-xs ${formData.comment.trim().length < 10
                    ? "text-red-500 dark:text-red-400"
                    : "text-gray-400 dark:text-gray-500"
                  }`}
              >
                {formData.comment.trim().length < 10
                  ? `Minimal ${10 - formData.comment.trim().length
                  } karakter lagi`
