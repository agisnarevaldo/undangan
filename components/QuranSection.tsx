    ...
    return (
        <section className="bg-section pb-4">
            <div className="mx-auto px-4 text-center">
                ...
                <div className="border border-gray-300 dark:border-gray-600 rounded-3xl shadow-lg p-4 mx-4 bg-white dark:bg-[#343a40]" data-aos="fade-up" data-aos-duration="1500">
                ...
                <div className="border border-gray-300 dark:border-gray-600 rounded-3xl shadow-lg p-4 mx-4 mt-3 bg-white dark:bg-[#343a40]" data-aos="fade-up" data-aos-duration="1500">
